...
const Footer = () => {
  ...
  return (
    <>
      <div className="flex flex-col h-[100vh] w-[100vw] bg-[#EDEAE0] overflow-x-hidden overflow-y-hidden  relative">
        <div className="bg-[#00211B] w-full flex flex-col flex-1 xs:flex-row items-center justify-center text-[#B0A47F]">
            ...
            <div className="flex max-w-[90%] mx-auto flex-col-reverse sm:flex-row-reverse sm:justify-center items-center gap-x-6 h-[5em] absolute bottom-0 right-0 left-0">
